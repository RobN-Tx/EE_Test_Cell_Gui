...
class Gather_Class:
    ...
    def __init__(self, config_data, testing_mode=False):
        ...
        self.script_file = config_data['script_file']
    ...
    def trigger_read(self):      
        ...
        try:
            trigger_value = self.comm.Read(self.trigger_tag)
    ...
    def store_data(self):
        ...
        #now to store the files on sharepoint!


    def call_mc(self):
        #method to call model center
        #mc = com.Dispatch('Phoenix.Modelcenter')
        #mc.loadModel(os.path.join(self.mc_directory, self.script_file)) 
